...
public final class FragmentChatBinding implements ViewBinding {
  ...
  private FragmentChatBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView userListRecyclerview) {
  ...
  public static FragmentChatBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.userListRecyclerview;
      RecyclerView userListRecyclerview = ViewBindings.findChildViewById(rootView, id);
      if (userListRecyclerview == null) {
        break missingId;
      }

      return new FragmentChatBinding((LinearLayout) rootView, userListRecyclerview);
    }
