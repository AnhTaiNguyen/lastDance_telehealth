...
import com.works.lastdance.doctor.models.AppointmentData
...
class AppointmentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtAppSurname.text = "Last Name : " + doctorSurname
        txtAppAge.text = "Age : " + doctorAge
        txtAppField.text = "Profession : " + doctorField
        ...
        val datePickerDialog = DatePickerDialog(
            ...
            DatePickerDialog.OnDateSetListener { _, selectedYear, selectedMonth, selectedDayOfMonth ->
                ...
                if (dayOfWeek == Calendar.SUNDAY) {
                    Toast.makeText(this, "No work on Sundays", Toast.LENGTH_LONG)
                        .show()
                } else {
            ...
            override fun onTimeSet(p0: TimePicker?, hour: Int, minute: Int) {
                ...
                if (hour < 9 || hour >= 17) {
                    Toast.makeText(
                        ...
                        "choose a time during business hours (9.00 - 17.00)",
                        Toast.LENGTH_LONG
                    ).show()
                } else {
            ...
            .addOnSuccessListener {
                newDoctorAppointmentRef.set(appointment)
                    ...
                    .addOnFailureListener { e ->
                            Log.w("AppointmentActivity", "Error", e)
                    }
            }
            .addOnFailureListener { e ->
                Log.w("AppointmentActivity", "An error", e)
            }
    }
