...
public final class ActivityNewsBinding implements ViewBinding {
  ...
  private ActivityNewsBinding(@NonNull ConstraintLayout rootView, @NonNull ListView newsListView) {
  ...
  public static ActivityNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsBinding((ConstraintLayout) rootView, newsListView);
    }
